...
namespace MTConnectAgentCore
{
    class Error
    {
        ...
        //
        internal static int UNSUPPORTED = 9;
            
        internal static XElement createError(Data _data, int _errorCode)
        {
        ...
        internal static String[] getErrorCode( int _errorCode)
        {
            ...
            switch( _errorCode )
            {
                ...
                case 4: 
                    error[0] = "TOO_MANY";
                    //error[1] = "The sequence number was beyond the end of the buffer.";
                    error[1] = "The count given is too large";
                    break;
                case 5: 
                    error[0] = "INVALID_URI";
                ...
                case 6:
                 ...
                 case 9:
                    error[0] = "UNSUPPORTED";
                    error[1] = "A valid request was provided, but the Agent does not support the feature of request type";
                    break;
                default:
                    error = null;
                    break;
